...
<Alert v-bind:icon="Error" v-bind:type="warning" v-bind:styling="bcgov-warning-background" v-bind:element="This is a warning message!" />
```
...
<Alert v-bind:icon="CloseCircle" v-bind:type="error" v-bind:styling="bcgov-error-background" v-bind:element="This is an error message!" />
```
...
<Alert v-bind:icon="Information" v-bind:type="info" v-bind:styling="bcgov-info-background" v-bind:element="This is an info message!" />
```
