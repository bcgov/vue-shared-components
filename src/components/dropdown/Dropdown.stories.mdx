...
| -------- | -------- | -------- | ---------------------------------------------------------------- | ------- |
| label    | string   | false    | value of the heading label for the dropdown                      | ""      |
...
<Dropdown label="My dropdown" items=items />
```
...
```bash
const items = ["Select an option", "Item 1", "Item 2"];
...
Basic dropdown with no label.

<Story name="With No Label" id="dropdown--no-label"></Story>
